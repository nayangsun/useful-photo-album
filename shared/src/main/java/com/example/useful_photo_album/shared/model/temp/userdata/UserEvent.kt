...
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_SUCCEEDED
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_DENIED_CUTOFF
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_DENIED_UNKNOWN
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_SUCCEEDED
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_CLASH
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_CUTOFF
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_UNKNOWN
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_WAITLISTED
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_SUCCEEDED
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_WAITLISTED
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_CUTOFF
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_CLASH
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_UNKNOWN
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequest.ReservationRequestEntityAction.RESERVE_REQUESTED
import com.example.useful_photo_album.shared.model.temp.reservations.ReservationRequest.ReservationRequestEntityAction.CANCEL_REQUESTED
